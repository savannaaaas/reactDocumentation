...
function Form() {
  ...
  },
  {
    ...
    content:[
      {
        p:"`useMemo` — это **хук для оптимизации производительности**, который позволяет **кэшировать результаты вычислений** и **избегать ненужных пересчётов** при каждом рендере. 

Он позволяет сохранять результат вычислений и повторно использовать его, если входные значения (зависимости) не изменились."
      }
    ]
  },
];
