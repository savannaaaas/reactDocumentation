...
const UserProfile = () => {
  ...
  return (
    <div>
      ...
      { b: "useLocation" },
      {
        p: "7. позволяет получать информацию о текущем URL и его параметрах в React Router.Когда ты используешь **`useLocation`**, ты можешь получить объект **`location`**, который содержит информацию о текущем URL",
      },
    ],
    path: "router",
  },
