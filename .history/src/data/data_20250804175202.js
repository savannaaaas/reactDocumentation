...
const Home = () => {
  ...
  return (
    <div>
      ...
      {
        p: "6. хук, который позволяет получать параметры из маршрута в React Router. Когда ты используешь **`useParams`**, ты можешь получить объект **`params`**, который содержит значения параметров из текущего маршрута.",
      },
    ],
    path: "router",
  },
