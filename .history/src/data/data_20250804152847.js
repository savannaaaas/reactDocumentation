...
export default Greeting;`,
      ...
      {
        err: "Если вы предоставляете собственную arePropsEqualреализацию, необходимо сравнить все свойства, включая функции. Функции часто замыкаются на свойствах и состоянии родительских компонентов. Если вы вернёте truewhen oldProps.onClick !== newProps.onClick, ваш компонент продолжит «видеть» свойства и состояние из предыдущего рендеринга внутри своего onClickобработчика, что приведёт к очень запутанным ошибкам. Избегайте глубоких проверок на равенство внутри, arePropsEqualесли вы не уверены на 100%, что структура данных, с которой вы работаете, имеет известную ограниченную глубину. Глубокие проверки на равенство могут стать невероятно медленными и привести к зависанию приложения на много секунд, если кто-то позже изменит структуру данных.",
      },
    ],
  },
];
