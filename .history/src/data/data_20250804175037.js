...
Messages
      ...
      {
        p: "5. **`useNavigate`** - это хук, который позволяет перенаправлять пользователя на другие маршруты в React Router.Когда ты используешь **`useNavigate`**, ты можешь получить функцию **`navigate`** и использовать ее для перенаправления пользователя на другой маршрут.",
      },
    ],
    path: "router",
  },
