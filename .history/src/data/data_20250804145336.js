...
const ChildComponent = () => < id="child" >
    ...
    <h1>Hello Child Component</h1>
      ...
      {
        err: "Если вы хотите передать key данные фрагменту, использовать этот синтаксис нельзя <>...</>. Вам придётся явно импортировать данные Fragmentиз фрагмента 'react'и отрисовывать их <Fragment key={yourKey}>...</Fragment>.",
      },
      {
