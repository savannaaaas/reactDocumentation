...
const UserProfile = () => {
  ...
  return (
    <div>
      ...
      { b: "useLocation" },
      {
        p: "Позволяет получать информацию о текущем URL и его параметрах в React Router. Когда ты используешь , ты можешь получить объект **`location`**, который содержит информацию о текущем URL",
      },
    ],
    path: "router",
  },
