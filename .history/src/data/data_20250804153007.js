...
export default Greeting;`,
      ...
      {
        err: "Если вы предоставляете собственную arePropsEqualреализацию, необходимо сравнить все свойства, включая функции. Функции часто замыкаются на свойствах и состоянии родительских компонентов. Если вы вернёте truewhen oldProps.onClick !== newProps.onClick, ваш компонент продолжит «видеть» свойства и состояние из предыдущего рендеринга внутри своего onClickобработчика, что приведёт к очень запутанным ошибкам.",
      },
    ],
  },
];
